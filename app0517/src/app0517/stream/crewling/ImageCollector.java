package app0517.stream.crewling;
...
public class ImageCollector {
	...
	String path="https://img4.yna.co.kr/photo/yna/YH/2010/02/01/PYH2010020102450000400_P2.jpg";
	...
	public ImageCollector() {
		...
		try {
			...
			long startTime = System.currentTimeMillis(); //현재 시간을 밀리 second 반환
			...
			long endTime = System.currentTimeMillis(); //현재 시간을 밀리 second 반
