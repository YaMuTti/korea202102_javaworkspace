...
public class MyWin{
	...
	public static void main(String[] args){
		...
		*/
		...
		//윈도우 안에 부착할 버튼 생성
		Button bt = new Button("나버튼"); //Button is a Component !!

		//버튼 부착후, 대왕버튼이 나오는 이유?
		//모든 GUI프로그래밍 에서는 화면의 배치 방법을 개발자가 결정해야 한다..
		//html에서 absolute, relative가 있듯.. GUI 응용프로그래밍 에서는 더욱 까다롭고 엄격하다
		//현재 우리는 아무런 배치(Layout)를 결정하지 않았기 때문에 시스템이 제공하는 디폴트 배치가
		//적용 되어 원하는 효과가 나오지 않은 것임...
