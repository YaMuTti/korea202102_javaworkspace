...
//계좌를 정의해본다!!
//자바는, 클래스간 서로 사용이 가능하므로 보안상 뜻하지 않았떤 문제가 발생할수있기
//때문에 이를 보완하기 위해 접근제한자는 보안처리를 지원한다..
//자바의 보안 처리는 다음과 같이 총 4단계로 구성된다..
/*
	(공개)		상속관계 or 같은패키지		같은 패키지만				나만 접근가능
...
public class Account{
	...
	//데이터에 대한 직접 접근을 막앗으나, 선의의 사용자도 사용하지 못하게 되었으므로,
